...
class Appointment(models.Model):
	class Meta:
		constraints = [
			models.UniqueConstraint(fields=['appointment_date', 'patient'], name="unique_date_for_patient"),
			models.UniqueConstraint(fields=['appointment_date', 'professional'], name="unique_date_for_professional")
		]
